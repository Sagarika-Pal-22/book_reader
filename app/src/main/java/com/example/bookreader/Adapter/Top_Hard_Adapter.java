...
public class Top_Hard_Adapter extends RecyclerView.Adapter<Top_Hard_Adapter.MyViewHolder> {

    Context context;
    List<Top_Hard_Model> book_models;

    public Top_Hard_Adapter(Context context, List<Top_Hard_Model> book_models) {
    ...
    public MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        View view = inflater.inflate(R.layout.single_top_hard, parent, false);
    ...
    public void onBindViewHolder(@NonNull MyViewHolder holder, final int position) {
        ...
        Glide.with(context)
                .load(book_models.get(position).getBook_image())
    ...
    public class MyViewHolder extends RecyclerView.ViewHolder {
        ...
        TextView  book_name, writer, price;
        RatingBar rating;
